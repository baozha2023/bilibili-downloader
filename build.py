...
def create_zip_archive():
    ...
    # 创建zip文件名
    zip_filename = f"bilibili_downloader_v2.0_{system}_{architecture}_{today}.zip"
...
def main():
    ...
    print("\n新版本 v2.0 更新内容:")
    print("- 重构代码结构，提升运行稳定性")
    print("- 优化登录弹窗，修复二维码显示问题")
    print("- 移除冗余功能描述，界面更简洁")
    print("- 优化下载流程和进度显示")
    print("- 修复已知BUG，提升用户体验")
